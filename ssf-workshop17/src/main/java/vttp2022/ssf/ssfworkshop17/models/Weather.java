package vttp2022.ssf.ssfworkshop17.models;
...
public class Weather implements Serializable{
    ...
    // to add individual object into the linkedlist 
    public void addConditions(String description, String icon){
    ...
    public static Weather create(String json) throws IOException{
            ...
            // will catch by itself and throw out 
